! function(e, t) {
    ...
    Fe = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, Pe = /[stwN]/, Ee = /[LRr]/, ze = /[Lb1n]/, Ie = /[1n]/;
    var Fe, Pe, Ee, ze, Ie, Re = function(e, t) {
        var n = "ltr" == t ? "L" : "R";
        ...
        return "ltr" == t && (1 == A[0].level && (O = e.match(/^\s+/)) && (A[0].from = O[0].length, A.unshift(new Be(0, 0, O[0].length))), 1 == I(A).level && (O = e.match(/\s+$/)) && (I(A).to -= O[0].length, A.push(new Be(0, i - O[0].length, i)))), "rtl" == t ? A.reverse() : A
    };
    ...
    function Nt(t, n, r, e) {
        for (var a = [t.state.modeGen], i = {}, u = (zt(t, n.text, t.doc.mode, r, function(e, t) {
                a.push(e, t)
            ...
            var o = t.state.overlays[e],
                l = 1,
                s = 0;
            r.state = !0, zt(t, n.text, o.mode, r, function(e, t) {
                for (var n = l; s < e;) {
                    var r = a[l];
    ...
    function gn(e, t, n) {
        this.line = t, this.rest = function(e) {
            ...
            return n
        }(t), this.size = this.rest ? H(I(this.rest)) - n + 1 : 1, this.node = this.text = null, this.hidden = nn(e, t)
    }
                    ...
                    b.scrollToPos && (v = function(e, t, n, r) {
                        ...
                        for (var i = 0; i < 5; i++) {
                            var o, l = !1,
                                ...
                                a = e.doc.scrollTop,
                                u = e.doc.scrollLeft;
                            if (null != s.scrollTop && (zr(e, s.scrollTop), 1 < Math.abs(e.doc.scrollTop - a) && (l = !0)), null != s.scrollLeft && (Rr(e, s.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - u) && (l = !0)), !l) break
                        }
                        return o
    ...
    function pi(e, t) {
        ...
        if (r && s || n && a) {
            ...
            if (r && !d && !K && null != i) return n && a && zr(e, Math.max(0, l.scrollTop + n * i)), Rr(e, Math.max(0, l.scrollLeft + r * i)), n && !a || D(t), void(o.wheelStartX = null);
    ...
    function vi(e) {
        return e.text ? F(e.from.line + e.text.length - 1, I(e.text).length + (1 == e.text.length ? e.from.ch : 0)) : e.to
    }
    ...
    function Ci(e) {
        ...
        }), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, qr(e, 100), e.state.modeGen++, e.curOp && z(e)
    }

    function Si(e, t) {
        return 0 == t.from.ch && 0 == t.to.ch && "" == I(t.text) && (!e.cm || e.cm.options.wholeLineUpdateBefore)
    }
    ...
    function Ti(e, t) {
        ...
        dr((e.doc = t).cm = e), xi(e), Mi(e), e.options.direction = t.direction, e.options.lineWrapping || ln(e), e.options.mode = t.modeOption, z(e)
    }
    ...
    function Di(e, t, n, r) {
        ...
        if ((l.lastOp == r || l.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && l.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (o = l).lastOp == r ? (Ai(o.done), I(o.done)) : o.done.length && !I(o.done).ranges ? I(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(), I(o.done)) : void 0)) i = I(o.changes), 0 == P(t.from, t.to) && 0 == P(t.from, i.to) ? i.to = vi(t) : o.changes.push(Oi(e, t));
        else {
            var a = I(l.done);
    ...
    function Wi(e, t, n, r) {
        var i, o, l, s = e.history,
            a = r && r.origin;
        n == s.lastSelOp || a && s.lastSelOrigin == a && (s.lastModTime == s.lastSelTime && s.lastOrigin == a || (e = e, i = a, o = I(s.done), l = t, "*" == (i = i.charAt(0)) || "+" == i && o.ranges.length == l.ranges.length && o.somethingSelected() == l.somethingSelected() && new Date - e.history.lastSelTime <= (e.cm ? e.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Hi(t, s.done), s.lastSelTime = +new Date, s.lastSelOrigin = a, s.lastSelOp = n, r && !1 !== r.clearRedo && Ai(s.undone)
    }
            ...
            if (o.ranges) r.push(n ? B.prototype.deepCopy.call(o) : o);
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        for (var h in c)(u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && (I(s)[h] = c[h], delete c[h])
                }
            }
        }
        return r
    ...
    function Ri(e, t, n, r, i) {
        null == i && (i = e.cm && (e.cm.display.shift || e.extend)), U(e, new B([Ii(e.sel.primary(), t, n, i)], 0), r)
    }

    function Bi(e, t, n) {
        for (var r = [], i = e.cm && (e.cm.display.shift || e.extend), o = 0; o < e.sel.ranges.length; o++) r[o] = Ii(e.sel.ranges[o], t[o], null, i);
    ...
    function ro(e, t, n, r) {
        ...
        if (t.to.line < e.first) no(e, t.text.length - 1 - (t.to.line - t.from.line));
            ...
            if ((t = t.to.line > i ? {
                ...
                qr(i, 400), l = o.text.length - (c.line - u.line) - 1, o.full ? z(i) : u.line != c.line || 1 != o.text.length || Si(i.doc, o) ? z(i, u.line, c.line + 1, l) : gr(i, u.line, "text"), d = je(i, "changes"), ((s = je(i, "change")) || d) && (l = {
                    from: u,
                    to: c,
                    text: o.text,
                    removed: o.removed,
    ...
    function mo(r, i, o, e, t) {
        ...
        if (r.iter(g, o.line + 1, function(e) {
                ...
                return d.clear()
            }), d.readOnly && (It = !0, (r.history.done.length || r.history.undone.length) && r.clearHistory()), d.collapsed && (d.id = ++go, d.atomic = !0), m) {
            if (p && (m.curOp.updateMaxLine = !0), d.collapsed) z(m, i.line, o.line + 1);
    ...
    po.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            null != r && t && this.collapsed && z(t, r, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, t && Xi(t.doc)), t && b(t, "markerCleared", t, this, r, i), n && _r(t), this.parent && this.parent.clear()
        }
        ...
        xo = ((f.prototype = Se(co.prototype, {
            ...
            unlinkDoc: function(e) {
                ...
                e.history == this.history && (r = [e.id], ki(e, function(e) {
                    return r.push(e.id)
                }, !0), e.history = new Ni(null), e.history.done = zi(this.history.done, r), e.history.undone = zi(this.history.undone, r))
            },
    ...
    function Io(e, t) {
        ...
        var n = No[e.keyCode];
        return null != n && !e.altGraphKey && zo(n = 3 == e.keyCode && e.code ? e.code : n, e, t)
    }
    ...
    function Vo(e, t, n, r, i) {
        if (e) {
            ...
            if (e) return o = i < 0 == (1 == (e = i < 0 ? I(e) : e[0]).level) ? "after" : "before", 0 < e.level || "rtl" == t.doc.direction ? (l = In(t, n), s = i < 0 ? n.text.length - 1 : 0, a = Rn(t, l, s).top, s = De(function(e) {
    ...
    function Ko(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || In(t, n), rr(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
        }
    ...
    function ll(e) {
        ...
        A(c, e) || h.activeTouch && h.input.supportsTouch() || (h.input.ensurePolled(), h.shift = e.shiftKey, Nn(h, e) ? x || (h.scroller.draggable = !1, setTimeout(function() {
            ...
            return qo(n, zo(o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o, i), i, function(e) {
            ...
            "rectangle" == p.unit ? (p.addNew || (m = new G(f, f)), f = fr(d, e, !0, !0), v = -1) : (e = sl(d, f, p.unit), m = p.extend ? Ii(m, e.anchor, e.head, p.extend) : e);
    ...
    function ml(e) {
        e.options.lineWrapping ? (ie(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (ee(e.display.wrapper, "CodeMirror-wrap"), ln(e)), dr(e), z(e), jn(e), setTimeout(function() {
            return Vr(e)
        }, 100)
    }
    ...
    function p(e, t) {
        ...
        k(s.scroller, "touchstart", function(e) {
            ...
            s.scroller.clientHeight && (zr(l, s.scroller.scrollTop), Rr(l, s.scroller.scrollLeft, !0), O(l, "scroll", l))
    ...
    function xl(e, t, n, r, i) {
        ...
        for (var h = e.curOp.updateInput, d = r.ranges.length - 1; 0 <= d; d--) {
            var f = r.ranges[d],
                p = f.from(),
                g = f.to(),
                f = (f.empty() && (n && 0 < n ? p = F(p.line, p.ch - n) : e.state.overwrite && !s ? g = F(g.line, Math.min(W(o, g.line).text.length, g.ch + I(a).length)) : s && bl && bl.lineWise && bl.text.join("\n") == a.join("\n") && (p = g = F(p.line, 0))), {
                    from: p,
                    to: g,
    ...
    function Tl() {
        ...
        return x ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), Y && (e.style.border = "1px solid black"), t
    }
    ...
    function Dl(e, t, n) {
        ...
        for (var i = 0; i < e.display.view.length; i++) {
            ...
            if (o.node == r) {
                ...
                if (o == s)
                    if (a = !0, o = s.childNodes[l], l = 0, !o) return Al(F(H(c = u.rest ? I(u.rest) : u.line), c.text.length), a);
    ...
    r.prototype.init = function(e) {
        ...
        function n(e) {
            if (a(e) && !A(l, e)) {
                ...
                var r = Tl(),
                    n = r.firstChild,
                    i = (kl(n), l.display.lineSpace.insertBefore(r, l.display.lineSpace.firstChild), n.value = bl.text.join("\n"), N(s.ownerDocument));
        ...
        for (var p = I(s), g = I(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0)); c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1);) ++c;
    ...
    i.prototype.init = function(n) {
        ...
        var t, n;
        this.contextMenuPending || this.composing && e || (t = this.cm, this.resetting = !0, t.somethingSelected() ? (this.prevInput = "", n = t.getSelection(), this.textarea.value = n, t.state.focused && se(this.textarea), w && 9 <= v && (this.hasSelection = n)) : e || (this.prevInput = this.textarea.value = "", w && 9 <= v && (this.hasSelection = null)), this.resetting = !1)
        ...
        var e = this,
            ...
            n = this.textarea,
            r = this.prevInput;
        if (this.contextMenuPending || this.resetting || !t.state.focused || nt(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq) return !1;
        var i = n.value;
        ...
        removeOverlay: t(function(e) {
            for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
                var r = t[n].modeSpec;
                if (r == e || "string" == typeof e && r.name == e) return t.splice(n, 1), this.state.modeGen++, void z(this)
            }
        }),
        ...
        addWidget: function(e, t, n, r, i) {
            ...
            }, null != (l = Dr(r, l)).scrollTop && zr(r, l.scrollTop), null != l.scrollLeft && Rr(r, l.scrollLeft))
        },
        ...
        refresh: t(function() {
            ...
            z(this), this.curOp.forceUpdate = !0, jn(this), Fr(this, this.doc.scrollLeft, this.doc.scrollTop), ni(this.display), (null == e || .5 < Math.abs(e - sr(this.display)) || this.options.lineWrapping) && dr(this), O(this, "refresh", this)
        }),
    ...
    var zl, Il = "iter insert remove copy getEditor constructor".split(" ");
    for (zl in f.prototype) f.prototype.hasOwnProperty(zl) && L(Il, zl) < 0 && (p.prototype[zl] = function(e) {
        return function() {
